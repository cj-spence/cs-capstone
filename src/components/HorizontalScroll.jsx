  ...
  const content = [
    {
      ...
      // Add Tailwind classes to override specific parts
      containerClasses: "", // Add classes for the outer container
      innerClasses: "" // Add classes for the inner container
    },
    {
      type: "text",
      id: 2,
      ...
      // Add Tailwind classes to override specific parts
      containerClasses: "", // Add classes for the outer container
      textContainerClasses: "", // Add classes for the text container
      titleClasses: "", // Add classes for the title
      descriptionClasses: "" // Add classes for the description
    },
    {
      type: "image",
      id: 3,
      ...
      containerClasses: "", // Add classes for the outer container
      innerClasses: "", // Add classes for the inner container
      imageClasses: "" // Add classes for the image itself
    },
    // ... rest of your content items
  ];

  return (
    <section ref={targetRef} data-aos="fade" className="relative h-[300vh]">
...
// VideoPlayer component remains exactly the same
