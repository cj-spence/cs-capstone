                        ...
                        <div className="bg-accent p-2 sm:p-3 md:p-4 rounded-lg w-full">
                            <Link to="/gallery/saintmarys">
                                <img 
                                    ...
                                    className='w-full h-[140px] sm:h-[180px] md:h-[210px] lg:h-[250px] xl:h-[300px] rounded-lg shadow-md hover:scale-105 duration-300 transition-transform object-cover'
                                />
                            </Link>
                        </div>
                    </div>
