...
export const GalleryMain = () => {
    return (
        ...
        >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-10 w-full justify-center max-w-screen-sm sm:max-w-screen-md md:max-w-screen-lg lg:max-w-screen-xl mx-auto">
                        ...
                        <div className="bg-accent p-2 sm:p-3 md:p-4 rounded-lg w-full">
                            <Link to="/gallery/saintmarys">
                                <img 
                                    ...
                                    className='w-full h-[130px] sm:h-[180px] md:h-[210px] lg:h-[250px] xl:h-[300px] rounded-lg shadow-md hover:scale-105 duration-300 transition-transform object-cover'
                                />
                            </Link>
                        </div>
                    </div>
